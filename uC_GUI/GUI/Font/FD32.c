...
GUI_FLASH const U8 acFont32[12][96] = {
{
...
GUI_FLASH const U8 acFont32_DP[2*32] = {
   ________,________,
   ________,________,
   ________,________,
   ________,________,
...
GUI_FLASH const U8 acFont32_Colon[2*32] = {
   ________,________,
   ________,________,
   ________,________,
   ________,________,
...
GUI_FLASH const U8 acFont32_Space[3*32] = {
   ________,________,________,
   ________,________,________,
   ________,________,________,
   ________,________,________,
...
GUI_FLASH const GUI_CHARINFO CharInfo32[] = {
   { 24,24,3, (void GUI_FLASH *)&acFont32[0]}		/* '0' */
  ,{ 24,24,3, (void GUI_FLASH *)&acFont32[1]}		/* '1' */
  ,{ 24,24,3, (void GUI_FLASH *)&acFont32[2]}		/* '2' */
  ,{ 24,24,3, (void GUI_FLASH *)&acFont32[3]} 	/* '3' */
  ,{ 24,24,3, (void GUI_FLASH *)&acFont32[4]}		/* '4' */
  ,{ 24,24,3, (void GUI_FLASH *)&acFont32[5]}		/* '5' */
  ,{ 24,24,3, (void GUI_FLASH *)&acFont32[6]}		/* '6' */
  ,{ 24,24,3, (void GUI_FLASH *)&acFont32[7]}		/* '7' */
  ,{ 24,24,3, (void GUI_FLASH *)&acFont32[8]}		/* '8' */
  ,{ 24,24,3, (void GUI_FLASH *)&acFont32[9]}		/* '9' */
  ,{ 16,16,2, (void GUI_FLASH *)&acFont32_Colon}	/* ':' */
  ,{ 24,24,3, (void GUI_FLASH *)&acFont32[11]}		/* '-' */
  ,{ 12,12,2, (void GUI_FLASH *)&acFont32_DP} 		/* '.' */
  ,{ 24,24,3, (void GUI_FLASH *)&acFont32[10]}		/* '+' */
  ,{ 24,24,3, (void GUI_FLASH *)&acFont32_Space}	/* ' ' */
};


/* Digits (48-57), 58: ':' */
GUI_FLASH const GUI_FONT_PROP FontProp32_3 = {
   48                 /* first character               */
  ,58                 /* last character                */
...
/* 45: '-', 46: '.' */
GUI_FLASH const GUI_FONT_PROP FontProp32_2 = {
   45                 /* first character               */
  ,46                 /* last character                */
  ,&CharInfo32[11]       /* address of first character    */
  ,(void GUI_FLASH *)&FontProp32_3  /* pointer to next GUI_FONTRANGE */
};

/* Plus sign */
GUI_FLASH const GUI_FONT_PROP FontProp32_1 = {
   43                 /* first character               */
  ,43                 /* last character                */
  ,&CharInfo32[13]       /* address of first character    */
  ,(void GUI_FLASH *)&FontProp32_2  /* pointer to next GUI_FONTRANGE */
};

/* Space */
GUI_FLASH const GUI_FONT_PROP FontProp32 = {
   32                 /* first character               */
  ,32                 /* last character                */
  ,&CharInfo32[14]       /* address of first character    */
  ,(void GUI_FLASH *)&FontProp32_1  /* pointer to next GUI_FONTRANGE */
};

GUI_FLASH const GUI_FONT GUI_FontD32 = {
   GUI_FONTTYPE_PROP /* type of font    */
  ,32                /* height of font  */
  ,32               /* space of font y */
  ,1                /* magnification x */
  ,1                /* magnification y */
  ,(void GUI_FLASH *)&FontProp32
};
