...
----------------------------------------------------------------------
1.00.01 011031 JE     a) GL_DrawBitmap called instead of GUI_DrawBitmap
...
void GUIPROP_AA2_GetFontInfo(void*pFont, GUI_FONTINFO* pfi) {
  GUI_USE_PARA(pFont);
  pfi->Flags = GUI_FONTINFO_FLAG_PROP | GUI_FONTINFO_FLAG_AA2;
}

char GUIPROP_AA2_IsInFont(void*pFont, U16 c) {
